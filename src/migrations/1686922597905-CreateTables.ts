...
<<<<<<<< HEAD:src/migrations/1686922597905-CreateTables.ts
export class CreateTables1686922597905 implements MigrationInterface {
    name = 'CreateTables1686922597905'
...
========
export class InitialMigration1686922048683 implements MigrationInterface {
    name = 'InitialMigration1686922048683'

    public async up(queryRunner: QueryRunner): Promise<void> {
>>>>>>>> 87172cf (Merge changes from develop branch):src/migrations/1686922048683-InitialMigration.ts
