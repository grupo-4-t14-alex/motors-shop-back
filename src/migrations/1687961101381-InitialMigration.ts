...
<<<<<<< HEAD:src/migrations/1687786714069-InitialMigration.ts
export class InitialMigration1687916984043 implements MigrationInterface {
    name = 'InitialMigration1687916984043'
=======
export class InitialMigration1687961101381 implements MigrationInterface {
    name = 'InitialMigration1687961101381'
>>>>>>> 172f036 (feat: added infos to the readme.rd file):src/migrations/1687961101381-InitialMigration.ts
...
<<<<<<< HEAD:src/migrations/1687786714069-InitialMigration.ts
        ...
        await queryRunner.query(`CREATE TABLE "comments" ("id" SERIAL NOT NULL, "comment" character varying NOT NULL, "createdAt" date NOT NULL DEFAULT now(), "userIdId" integer, "carIdId" integer, CONSTRAINT "PK_8bf68bc960f2b69e818bdb90dcb" PRIMARY KEY ("id"))`);
